...
const landmarkText = {
    ...
    turtlebot: "I started learning ROS in January of 2022, first learning Gazebo because the lab did not have any physical robots that were running or could run ROS. I completed numerous simulations with Turtlebot3's, before finally convincing the head of the lab to get two Turtlebot4's. Once we had physical robots I started working on a mail delivery system for the mechanical engineering department. I attatched a robotic servo arm to one of the turtlebots, and a basket to carry mail to the other.",
    unitree: "This project gave me experience with ROS2 Humble, using LiDAR scanners for obstacle avoidance and localization, using cameras and ArUco tags for localization and initializing behavior trees, and using C/C++ for programming robotic arms."
};
